class AppLocalization {
  static Map<String, String> get englishLanguage => {
    ...
    "week":"week",
    "month":"month",
    "missed_day_tip":"Tue · Missed. Everyone has off days. Tomorrow's a fresh start.",
    ...
    "optional":"Optional",
    "minimum_version_description":"Define a lighter version for low-energy days — like a 5-minute walk instead of 30 minutes. If left off, only the regular completion is tracked.",
    "name":"Name",
